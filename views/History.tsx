      ...
      <Card>
        <div className="flex justify-between items-center mb-4">
            <input 
                ...
                className="block w-full md:w-1/3 bg-secondary dark:bg-gray-700 border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:ring-primary focus:border-primary text-text-main dark:text-gray-100 p-2"
            />
        </div>
